...
export default function Basic(props: BasicProps) {
  ...
  return (
    <Layout
      title="Traffic Jam Cars Puzzle - Victory Game"
          ...
          <div className="reskin_after">
            ...
            <div className="reskin_after_text">
              <p className="reskin_after_text_p">
                ...
                match 3 puzzle game! With innovative gameplay and a wide array
                of interesting items, the game offers a fresh and engaging
                experience. With over 6000 levels to explore, it is a game that
                never runs out of challenges. Traffic Jam Cars Puzzle achieved
                impressive rankings in the casual puzzle genre: #80 in the US,
                #50 in Japan, #150 in Great Britain and Germany, and #200 in
                Korea.
              </p>
            </div>
          </div>
